...
class Api {
    static apiUrl = process.env.REACT_APP_API_URL === undefined || process.env.REACT_APP_API_URL === null || !process.env.REACT_APP_API_URL ? process.env.PUBLIC_URL : process.env.REACT_APP_API_URL;
